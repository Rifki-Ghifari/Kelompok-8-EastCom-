...
<html>
<head>
	<title>MyCatalog - Kelompok 8</title>
...
<body>
	<div class="container-fluid" >
		<div class="row top" style="background-color: #379237">
			<center>
				<div class="col-md-4"  style="padding: 3px;">KELOMPOK 8</div>
				<div class="col-md-4"  style="padding: 3px;"></div>
				<div class="col-md-4"  style="padding: 3px;">EASTCOM</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a href="index.php">
				<img src="image/mycatalog.png" alt="">
				</a>
			</div>

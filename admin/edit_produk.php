		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="masukkan lokasi rak" name="lokasi_rak" value="<?= $data['lokasi_rak']; ?>">
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="masukkan Kategori" name="kategori" value="<?= $data['kategori']; ?>">
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="number" class="form-control" id="exampleInputEmail1" placeholder="masukkan Stock" name="stock" value="<?= $data['stock']; ?>">
				</div>
			</div>
			<div class="col-md-6">

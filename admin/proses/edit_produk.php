...
if($eror === 4){
	...
	$result = mysqli_query($conn, "UPDATE produk SET nama = '$nm_produk', harga = '$harga' where kode_produk = '$kode'");
...
if (file_exists("../../image/produk/".$tgambar['image'])) {
	...
	$result = mysqli_query($conn, "UPDATE produk SET nama = '$nm_produk', image = '$namaGambarBaru' , harga = '$harga' where kode_produk = '$kode'");
